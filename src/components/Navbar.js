...
{/* Navigation Menu 'open settings' true/false ====> */}

            {
                ...
                className='w-[70vw] h-[50vw] md:w-[50vw] lg:w-[30vw] z-50 justify-evenly border items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/80 text-white dark:text-black dark:bg-white/75 rounded-lg backdrop-blur-sm py-32 antialiased'>
