    ...
    return (
        <div className="lg:fixed left-4 bottom-32 flex items-center justify-center overflow-hidden">
            <div className="w-48 h-auto flex items-center justify-center relative">
                ...
                <MotionLink href="mailto:ecv1ii4im@mozmail.com" className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-black text-light shadow-lg border border-transparent dark:hover:drop-shadow-md w-20 h-20 rounded-full font-semibold transform transition duration-300 hover:bg-white dark:hover:bg-teal-500"
                whileHover={{
